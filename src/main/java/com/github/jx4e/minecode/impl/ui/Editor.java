...
public class Editor extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        RenderManager.instance().getRenderer().box(matrices, 0, 0, width / 5, height, activeTheme.getBackground1());
        ...
        matrices.push();
        panel.setText(project.getMainScript().getContent());
        panel.setX(width / 5);
        panel.setY((int) barHeight);
        panel.setWidth(width - width / 5);
